...
class MyWindow(QMainWindow):
    ...
    def setupUI(self):
        ...
        self.checkBox2 = QCheckBox("닭곰탕", self)
        ...
        self.checkBox15 = QCheckBox("갈비탕", self)
        self.checkBox15.move(140, 70)
        self.checkBox15.resize(150, 30)
        self.checkBox15.stateChanged.connect(self.checkBoxState)

        self.checkBox16 = QCheckBox("부대찌개", self)
        self.checkBox16.move(140, 50)
        self.checkBox16.resize(150, 30)
        self.checkBox16.stateChanged.connect(self.checkBoxState)
    ...
    def checkBoxState(self, result):
        ...
        if self.checkBox15.isChecked() == True:
            food += '갈비탕, '
        if self.checkBox16.isChecked() == True:
            food += '부대찌개, '
